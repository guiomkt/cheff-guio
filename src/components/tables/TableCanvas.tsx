...
export function TableCanvas({
  ...
  const handleZoom = (zoomIn: boolean) => {
    setScale(prev => {
      ...
      return Math.max(0.2, Math.min(3, newScale)); // Permitir mais zoom out e zoom in
    });
  };
  ...
  return (
    ...
    >
      {/* Controlers de zoom e centralização */}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  willChange: isDragging ? 'transform' : 'auto', // Otimização de performance
